...
export const ExpeditionRoadmap: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const generatedSprints: Sprint[] = [
      ...
      {
        week: 5,
        title: sortedSkills[4]?.name || 'Behavioral & Leadership',
        status: 'completed',
        score: sortedSkills[4]?.score || 75,
        drills: [
          { id: 'w5d1', title: 'STAR Method Scenarios', completed: false },
          { id: 'w5d2', title: 'Conflict Resolution', completed: false },
          { id: 'w5d3', title: 'Leadership Principles', completed: false },
        ],
      },
      {
        week: 6,
        ...
        score: 74,
        drills: [
          { id: 'w6d1', title: 'Continuous Scroll-Reveal Workflow', completed: false },
          { id: 'w6d2', title: 'Roast My Repo', completed: false },
          { id: 'w6d3', title: '60s Spoken Mic Defense', completed: false },
        ],
      },
    ];
