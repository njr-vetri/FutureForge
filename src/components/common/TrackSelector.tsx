    ...
    <div className="min-h-screen bg-[#EFE9D8] text-[#1A1D1B] flex flex-col justify-between p-6 md:p-12 selection:bg-[#C9962C]/30">
      ...
      <div className="max-w-6xl mx-auto w-full flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-[#1F3A34] text-[#C9962C] flex items-center justify-center font-display font-bold text-xl shadow-sm border border-[#2A4D45]">
            C
          </div>
          <div>
            <h1 className="text-xl font-display font-bold tracking-tight text-[#1A1D1B]">
              CareerOS
            </h1>
            <span className="text-[11px] font-mono uppercase tracking-widest text-[#1A1D1B]/60">
              Student Placement Intelligence Platform
            </span>
          </div>
        </div>

        <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/80 border border-[#DCD4C0] text-xs font-mono">
          <ShieldCheck className="w-4 h-4 text-[#1F3A34]" />
          <span>NIT Placement Portal Active</span>
        </div>
      </div>
